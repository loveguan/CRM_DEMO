...
class ClassList(models.Model):
    ...
    teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo', related_name="abc",
                                      limit_choices_to={"depart__in": [1, 2,3,4,5]})
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',
                              limit_choices_to={"depart":6},on_delete=models.CASCADE)
...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', related_name='consultanter',
                                   limit_choices_to={'depart_id': 1},on_delete=models.CASCADE)
...
class CourseRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo', limit_choices_to={"depart_id__in": [1, 2]},on_delete=models.CASCADE)
